...
def generate_map():
    room1 = Room("Entrance Hall", "Dark and musty, with cobwebs in the corners.", {"e": "room2"})
    room2 = Room(
        "Torchlit Corridor",
    ...
    room3 = Room(
        "Goblin Lair",
        "You hear snarling in the dark...",
        {"n": "room2"},
        enemies=make_multiple_enemies(make_goblin, 1)+ make_multiple_enemies(make_spider, 1)
    )
